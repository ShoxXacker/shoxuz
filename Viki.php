<?php
ob_start();
define('API_KEY', '1249857046:AAGBHNmPcU1IoNt2f3SMon1XNeujH4fP2qc');
$admin = "1171894731"; 
$kanali = "@Hacker_Bey";
...
$token = "1249857046:AAGBHNmPcU1IoNt2f3SMon1XNeujH4fP2qc";
...
'inline_keyboard'=>[
[['text'=>"💎UzBotsGroup",'url'=>"https://telegram.me/Hacker_Bey"]]
]
])
]);
}
...
if ($text1 == "/sozlama" or $text1 == "/sozlama@ValijonBot"){
if ($cty == "group" or $cty == "supergroup"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
...
if($text1 == "/silent" or $text1 == "silent" or $text1 == "/silent@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
]);
...
[['text'=>"ℹ Kanalimiz",'url'=>"https://telegram.me/UzkodNews"]]
    ]
    ])
]);
}
...
if($text1  == "/unsilent" or $text1 == "unsilent" or $text1  == "/unsilent@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
]);
...
'parse_mode'=>"html",
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
[['text'=>"$repname", 'url'=>"https://telegram.me/$repuser"]],
[['text'=>"ℹKanalimiz",'url'=>"https://telegram.me/Uzkod"]]
    ]
    ])
]);
}
...
if($text1=="/adminlar" or $text1 == "/adminlar@ValijonBot"){
...
if ($text1 == "/start" or $text1 == "/start@ValijonBot" or $text1 == "/sozlama" or $text1 == "/sozlama@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
]);
...
if ($text1 == "/start" or $text1 == "/start@ValijonBot" and $cty =="private"){
$chm = file_get_contents("news.txt");
bot('forwardMessage', [
'chat_id'=>$chat_id,
'from_chat_id'=>$kanali,
...
[['text'=>"👷Kanalimiz",'url'=>"https://t.me/Hacker_Bey"],['text'=>"💎Qiziqarli",'callback_data'=>"dost"]],
...
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
[['text'=>"ℹBuyruqlarim",'callback_data'=>"buyruq"],['text'=>"📊Statistikam",'callback_data'=>"stat"]],
[['text'=>"👷Kanalimiz",'url'=>"https://t.me/HitsTv"],['text'=>"💎Qiziqarli",'callback_data'=>"dost"]],
[['text'=>"🆔Aniqlash",'switch_inline_query'=>"@"]],
[['text'=>"➡Guruhga qo'shish",'url'=>"telegram.me/Valijonbot?startgroup=new"]]
]
]),
...
*Qo'llab-quvvatlash markazi:* [@VikiSupport]",
'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
...
💎*Yaratuvchi:* [Shox_Xacker](https://t.me/ValiAlijon_Bot)",
   ]);
 }
...
'caption'=>"💎*Yaratuvchi:* [Shox_Xacker](https://t.me/ValiAlijon_Bot)",
'parse_mode'=>"markdown",
'reply_to_message_id'=> $mid,
]);
}
...
'inline_keyboard'=>[
[['text'=>"🆔Aniqlash",'switch_inline_query'=>"@"],],
[['text'=>"💎Botga kirish",'url'=>"https://t.me/ValiAlijon_Bot"],],
[['text'=>"👥Guruhga qo'shish",'url'=>"telegram.me/ValiAlijon_Bot?startgroup=new"],],]],
]
])
]);
}
...
'inline_keyboard'=>[
[['text'=>"🆔Aniqlash",'switch_inline_query'=>"@"],],
[['text'=>"💎Botga kirish",'url'=>"https://t.me/ValijonBot"],],
[['text'=>"👥Guruhga qo'shish",'url'=>"telegram.me/ValijonBot?startgroup=new"],],]],
]
])
]);
...
if($text1 == "/setphoto" or $text1 == "/setphoto@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 == "/delphoto" or $text1 == "/delphoto@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "/leave"  or $text1 == "/leave@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
'chat_id'=>$chat_id,
'parse_mode'=>"html",
'text'=>"📛@ValiAlijon_Bot'<b>ning guruhdagi faoliyati to'xtatildi:</b>
...
if ($text1 == "/admins" or $text1 == "/admins@ValijonBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 =="/text@ValijonBot" or $text1 =="/text") {
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1=="/ban" or $text1=="/Ban" or $text1=="/ban@ValijonBot"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 =="/ro" or $text1 =="/ro@ValiAlijon_Bot"){
  $gett=bot('getchatmember',[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1=="/unro" or $text1 =="/unro@ValijonBot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/kick" or $text1 =="/kick@ValiAlijon_Bot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/warn" or $text1 =="/warn@ValiAlijon_Bot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/nowarn" or $text1 =="/nowarn@ValiAlijon_Bot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/mywarn" or $text1 =="/mywarn@ValiAlijon_Bot"){
$war=file_get_contents("warn1.dat");
$soni="$chat_id=$fadmin";
$str=substr_count($war,"$soni");
    bot('sendmessage',[
...
if($text1 =="/unban" or $text1 =="/unban@ValiAlijon_Bot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if(isset($update) and $Schats == "true"){
 ...
 if($fadmin==$admin){
    bot('sendmessage',[
      'chat_id'=>$chat_id,
      'text'=>"😱 @Shox_Xacker xo'jayin keldi!",
'reply_to_message_id'=> $mid,
      ]);
  }else{
  $name = $message->from->first_name;
...
Namuna:*
`Shox_Xacker + https://t.me/Shox_Xacker`",
          ]);      
}
